# ============================================================================
# VERBATIM PORT -- DO NOT EDIT BY HAND.
#
# Source : src/cfb_edge_finder/research/v2/features.py
# Branch : claude/cfb-model-v2-research-krupoc @ c1eedc9
# sha256 : 8ace346ab1748e9c88519f8e0a1167114ce56b00d63155320c7a5114584bb6b7
#
# This is the frozen V2 feature builder, copied unchanged so the
# production artifact's predictions are computed by literally the same
# code that produced the research numbers -- not by a re-implementation
# that "should" agree. tests/test_v2_shadow.py re-hashes this file
# against the recorded sha256, so an accidental edit fails loudly rather
# than silently changing what V2 means.
#
# It is BUILD-TIME code: scripts/build_v2_shadow_artifact.py uses it to
# produce the frozen artifact. The 5-minute capture path never imports
# it -- production inference is a lookup against the frozen per-game
# predictions in the artifact.
# ============================================================================
